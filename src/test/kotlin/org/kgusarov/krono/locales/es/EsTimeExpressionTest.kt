...
internal class EsTimeExpressionTest {
    ...
    internal fun `date time expression`() {
        testSingleCase(
            ...
            assertThat(it.index).isEqualTo(13)
    ...
    internal fun `random date time expression`(
        ...
        testSingleCase(Krono.esCasual, text, "2012-08-10T00:00:00") {
            with(it.start) {
    ...
    companion object {
        ...
        fun randomDateTimeExpressionArgs(): Stream<Arguments> = Stream.of(
            Arguments.of("lunes 4/29/2013 630-930am", "2013-04-29T06:30:00", "2013-04-29T09:30:00"),
            Arguments.of("martes 5/1/2013 1115am", "2013-01-05T11:15:00", null),
            Arguments.of("miércoles 5/3/2013 1230pm", "2013-03-05T12:30:00", null),
            Arguments.of("domingo 5/6/2013  750am-910am", "2013-06-05T07:50:00", "2013-06-05T09:10:00"),
            Arguments.of("lunes 5/13/2013 630-930am", "2013-05-13T06:30:00", "2013-05-13T09:30:00"),
            Arguments.of("miércoles 5/15/2013 1030am", "2013-05-15T10:30:00", null),
            Arguments.of("jueves 6/21/2013 2:30", "2013-06-21T02:30:00", null),
            Arguments.of("martes 7/2/2013 1-230 pm", "2013-02-07T13:00:00", "2013-02-07T14:30:00"),
            Arguments.of("Lunes, 6/24/2013, 7:00pm - 8:30pm", "2013-06-24T19:00:00", "2013-06-24T20:30:00"),
            Arguments.of("Miércoles, 3 Julio de 2013 a las 2pm", "2013-07-03T14:00:00", null),
            ...
            Arguments.of("las 12", "2012-08-10T12:00:00", null),
        )
    }
}
